...
def plot_one_box(x, img, color=None, label=None, line_thickness=3):
    ...
    if label:
        ...
        cv2.putText(img, f'{(x[2] + x[0])/2}', (c1[0], c1[1] - 25), 0, tl / 3, [225, 255, 255], thickness=tf, lineType=cv2.LINE_AA)
        cv2.putText(img, f'{(x[3] + x[1])/2}', (c1[0], c1[1] - 50), 0, tl / 3, [225, 255, 255], thickness=tf, lineType=cv2.LINE_AA)
